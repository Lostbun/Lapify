...
let sections = document.querySelectorAll('section');
  ...
  window.addEventListener('scroll', function(){
     ...
     if(marginTopNumber <= 100){
        document.getElementById('laptophover').style.backgroundImage="url('rogstrixg16.png')";

     }
     else if(marginTopNumber <= 200 ){
        document.getElementById('laptophover').style.backgroundImage="url('rogtilt.png')";

     }
     else if(marginTopNumber <= 300){
        document.getElementById('laptophover').style.backgroundImage="url('rogfold.png')";
...
carouselSlide.addEventListener('transitionend', () => {
    ...
    if(carouselImages[counter].id == 'tuf'){
        console.log('TUF');    
        document.getElementById("roginfolog").style.backgroundImage="url('tuflogo.png')";
    ...
    if(carouselImages[counter].id == 'rog'){
        console.log('ROG');    
        document.getElementById("roginfolog").style.backgroundImage="url('roglogo.png')";
    ...
    if(carouselImages[counter].id == 'msi'){
        console.log('MSI');    
        document.getElementById("roginfolog").style.backgroundImage="url('msilogo.png')";
    ...
    if(carouselImages[counter].id == 'legion'){
        ...
        document.getElementById("roginfolog").style.backgroundImage="url('legionlogo.png')";
    ...
    if(carouselImages[counter].id == 'aorus'){
        console.log('AORUS');    
        document.getElementById("roginfolog").style.backgroundImage="url('aoruslogo.png')";
    ...
    if(carouselImages[counter].id == 'predator'){
        ...
        document.getElementById("roginfolog").style.backgroundImage="url('predatorlogo.png')";   
